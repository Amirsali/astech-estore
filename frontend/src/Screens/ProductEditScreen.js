...
export default function ProductEditScreen(props) {
  ...
  useEffect(() => {
    if (successUpdate) {
      if (window.confirm("Changes saved! View all products?")) {
  ...
  return (
    <div className="productEdit__container">
      <form className="form__edit" onSubmit={handleSubmit}>
        <div>
          <h1 className="form__edit--title">Product ID: {productId}</h1>
        ...
        {loading ? (
          ...
          <>
            ...
            <div>
              <label htmlFor="countInStock">Number of Stocks</label>
              <input
                id="countInStock"
                type="text"
